...
void JscEngine::initInternalSymbols() {
  ...
  try {
    ...
    if (symbol.isFunction()) {
      ...
      internalStorageSymbol_ = String::newString("__ScriptCore_InternalStorageSymbol__");
      constructorMarkSymbol_ = String::newString("__ScriptCore_ConstructorMarkSymbol__");
    }
