...
#include "Exception.h"
#include "Reference.h"
#include SCRIPTCORE_BACKEND(Native.h)
#include SCRIPTCORE_BACKEND(Engine.h)
#include SCRIPTCORE_BACKEND(Utils.h)
...
class Arguments {
 ...
 public:
  ...
  SCRIPTCORE_DISALLOW_COPY_AND_MOVE(Arguments);
...
class ScriptClass {
 public:
  SCRIPTCORE_DISALLOW_COPY_AND_MOVE(ScriptClass);
...
class InternalStoreHelper {
 public:
  ...
  SCRIPTCORE_DISALLOW_COPY_AND_MOVE(InternalStoreHelper);
...
#define SCRIPTCORE_CLASS_DEFINE_FRIENDS                                          \
...
class StaticDefine {
  class PropertyDefine {
    ...
    SCRIPTCORE_CLASS_DEFINE_FRIENDS;
  };
...
#undef SCRIPTCORE_CLASS_DEFINE_FRIENDS
