...
std::shared_ptr<script::ScriptEngine> createEngine() {
#if !defined(SCRIPTCORE_BACKEND_WEBASSEMBLY)
...
#ifdef SCRIPTCORE_LANG_JAVASCRIPT
  return R"(
    var img = API.createImage("https://github.githubassets.com/images/icons/emoji/tada.png");
    API.drawImage(img);
    img.drop();
...
#elif defined(SCRIPTCORE_LANG_LUA)
  return R"(
    local img = API.createImage("https://github.githubassets.com/images/icons/emoji/tada.png");
    API.drawImage(img);
    img:drop();
